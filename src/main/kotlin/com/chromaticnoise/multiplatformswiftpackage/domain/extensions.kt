...
internal val Collection<Either<List<PluginConfiguration.PluginConfigurationError>, TargetPlatform>>.platforms
    get() =
        filterIsInstance<Either.Right<List<PluginConfiguration.PluginConfigurationError>, TargetPlatform>>().map { it.value }

internal val Collection<Either<List<PluginConfiguration.PluginConfigurationError>, TargetPlatform>>.errors
    get() =
        filterIsInstance<Either.Left<List<PluginConfiguration.PluginConfigurationError>, TargetPlatform>>().map { it.value }
            .flatten()
